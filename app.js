...
app.get("/homed", MysqlController.helper.authenticateAdmin, MysqlController.homed);
...
app.post("/pickups", MysqlController.helper.authenticate, MysqlController.pickups);
